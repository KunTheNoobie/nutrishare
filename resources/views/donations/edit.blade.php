                    ...
                    <div class="mb-4">
                        ...
                        <div class="tab-content" id="photoTabContent">
                            <div class="tab-pane fade show active" id="upload" role="tabpanel">
                                ...
                                <div class="text-muted small mt-1">Upload new images (JPEG, PNG, GIF — Max 100MB each).</div>
                            ...
                            <div class="tab-pane fade" id="url" role="tabpanel">
                                @php
                                    ...
                                    if ($donation->image_paths) {
                                        foreach($donation->image_paths as $p) {
                                ...
                                <div id="urlInputsContainer">
                                    @if(count($urlList) > 0)
                                        @foreach($urlList as $idx => $uVal)
                                        <div class="input-group mb-2 url-input-group">
                                            <span class="input-group-text"><i class="bi bi-link"></i></span>
                                            <input type="url" class="form-control image-url-input" name="image_urls[]" value="{{ $uVal }}" placeholder="https://example.com/image.jpg">
                                            @if($idx > 0)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateUrlPreviews() {
        if (!urlPreviewGrid || !urlInputsContainer) return;
    ...
    if (urlInputsContainer) {
        ...
        // Initial render for pre-filled edit URLs
        updateUrlPreviews();
    }
    ...
    if (addUrlBtn && urlInputsContainer) {
        ...
        // Attach listeners to existing remove buttons in edit mode
        urlInputsContainer.querySelectorAll('.remove-url-btn').forEach(btn => {
